...
import com.example.alhamdulillah.App;
import com.example.alhamdulillah.R;
import com.example.alhamdulillah.Note;
import com.example.alhamdulillah.NoteDetailsActivity;

import java.util.List;

public class AdapterAchievs extends RecyclerView.Adapter<AdapterAchievs.NoteViewHolder> {

    private SortedList<Note> sortedList;

    public AdapterAchievs() {
